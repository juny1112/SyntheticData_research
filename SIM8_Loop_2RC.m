...
%  • 각 target SOC(90·50·20)를 통과하는 SIM 1개를 찾고
%    → 그 SIM을 중심으로 앞4개 뒤3개 (총8개) 묶어 피팅.
% ======================================================================
clc; clear; close all;
...
for f = [2 3 7]%1:numel(sim_files)
    ...
    % 4) Figure
    rows = 3; cols = 8;
    figure('Name',[base_raw ' – 2RC fitting'],'NumberTitle','off',...
           'Position',[100 100 1600 900]);
    sgtitle(strrep(base_raw,'_','\_') + " – 2RC fitting",...
            'Interpreter','tex');
    ...
    for s = 1:nSeg
        ...
        grid on; legend('True','Fitted','Initial','Location','northeast');
